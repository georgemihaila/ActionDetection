...
namespace ActionDetection.API.Infrastructure.Extensions
{
    public static class ImageExtensions
    {
        ...
        public static Image? GetMotionDetectionFrame(this Camera camera, int sensitivity, int chunks) => GenerateMotionDetectionFrame(camera, camera.CurrentFrame, sensitivity, chunks);
        ...
        public static async Task<Image?> GetMotionDetectionFrameAsync(this Camera camera, ImageSize imageSize, int sensitivity, int chunks)
        {
            ...
            return GenerateMotionDetectionFrame(camera, frame, sensitivity, chunks);
        }

        private static Image? GenerateMotionDetectionFrame(this Camera camera, Image? currentFrame, int sensitivity, int chunks)
        {
